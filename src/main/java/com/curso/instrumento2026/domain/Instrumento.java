...
public class Instrumento {
    ...
    public Instrumento(Long id, String codigoInstrumento, String nomeInstrumento, int quantidadeEstoque, BigDecimal precoUnitario, LocalDate dataCadastro,
                                  Status status, CategoriaInstrumento categoria) {

        if (codigoInstrumento == null || codigoInstrumento.isBlank()) {
            throw new IllegalArgumentException("Código do instrumento é obrigatório");
        }
        ...
        if (precoUnitario == null || precoUnitario.compareTo(BigDecimal.ZERO) <= 0) {
            throw new IllegalArgumentException("Preço unitário deve ser maior que zero e nem negativo");
        }
